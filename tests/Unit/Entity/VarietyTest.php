...
//        $this->mockTraitOuterExtensible->initOuterExtendedClasses();
    ...
    public function test__call() {
        ...
        $varietydescriptionplant = new VarietyDescriptionPlant;
        $varietydescriptionplant->setField('foliage_type');
        $varietydescriptionplant->setValue('testvalue');
        $getvalue = $varietydescriptionplant->getValue();
        //dump($varietydescriptionplant);
        $this->object->AddPlantDescription($varietydescriptionplant);
        $name = "plant||foliage_type";
        $testcall = $this->object->__call($name);
        $this->assertEquals($testcall, $getvalue);
    }
...
//        $this->assertEquals;
    ...
    /**
     * @covers Librinfo\VarietiesBundle\Entity\Variety::setVariety
     * @todo   Implement testSetVariety().
     */
    public function testSetVariety() {
        // Remove the following lines when you implement this test.
        $this->markTestIncomplete(
                'This test has not been implemented yet.'
        );
    ...
    /**
     * @covers Librinfo\VarietiesBundle\Entity\Variety::getVariety
     * @todo   Implement testGetVariety().
     */
    public function testGetVariety() {
        // Remove the following lines when you implement this test.
        $this->markTestIncomplete(
                'This test has not been implemented yet.'
        );
